...
const CACHE_NAME = 'fuelphysique-v45-food-save-2';
...
const urlsToCache = [
  ...
  '/css/daily-nutrition.css?v=20260918-food-save-2',
  ...
  '/js/redesign-shell.js?v=20260914-i18n-dashboard-1',
  '/js/daily-nutrition.js?v=20260918-food-save-2',
  '/js/daily-food-visuals.mjs?v=20260918-food-save-2',
  '/images/common/meal.svg',
  '/js/daily-nutrition-domain.mjs?v=20260918-food-save-2',
  '/js/daily-nutrition-store.mjs?v=20260914-i18n-dashboard-1',
  '/js/daily-nutrition-i18n.mjs?v=20260918-food-save-2',
