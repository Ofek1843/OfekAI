...
function render(kind){const copy=he?{
  active:["✅","המינוי פעיל","TrainIQ Pro הופעל בהצלחה בחשבון שלך.","חזרה לדשבורד"],
