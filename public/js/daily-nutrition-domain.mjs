...
const FOOD_CATALOG = Object.freeze([
  ...
  // State is nutritionally material for grains. Keep the dry record separate
  // from cooked rice so an explicit "dry" / "יבש" qualifier is never silently
  // discarded and converted to the much lower cooked-weight value.
  { id: "rice-dry", name: { en: "Dry white rice", he: "אורז לבן יבש" }, aliases: ["dry rice", "uncooked rice", "raw rice", "dry white rice", "אורז יבש", "אורז לא מבושל", "אורז נא", "אורז לבן יבש"], baseAmount: 100, baseUnit: "g", specificity: "generic", macros: { calories: 365, protein: 7.1, carbs: 80, fat: 0.7 }, reference: { source: "generic dry white rice", ediblePortion: true, state: "dry", policy: "representative-not-brand" } },
  ...
  { id: "chicken-breast-raw", name: { en: "Raw chicken breast", he: "חזה עוף נא" }, aliases: ["raw chicken breast", "uncooked chicken breast", "raw chicken", "uncooked chicken", "חזה עוף נא", "חזה עוף לא מבושל", "עוף נא"], baseAmount: 100, baseUnit: "g", specificity: "generic", macros: { calories: 120, protein: 22.5, carbs: 0, fat: 2.6 }, reference: { source: "generic raw skinless chicken breast", ediblePortion: true, state: "raw", policy: "representative-not-brand" } },
  ...
  { id: "lentils-dry", name: { en: "Dry lentils", he: "עדשים יבשות" }, aliases: ["dry lentils", "uncooked lentils", "raw lentils", "עדשים יבשות", "עדשים לא מבושלות", "עדשים נא"], baseAmount: 100, baseUnit: "g", specificity: "generic", macros: { calories: 352, protein: 24.6, carbs: 63.4, fat: 1.1 }, reference: { source: "generic dry lentils", ediblePortion: true, state: "dry", policy: "representative-not-brand" } },
  ...
  { id: "chickpeas-dry", name: { en: "Dry chickpeas", he: "גרגרי חומוס יבשים" }, aliases: ["dry chickpeas", "uncooked chickpeas", "raw chickpeas", "dry garbanzo beans", "גרגירי חומוס יבשים", "גרגרי חומוס יבשים", "חומוס יבש", "חומוס לא מבושל"], baseAmount: 100, baseUnit: "g", specificity: "generic", macros: { calories: 378, protein: 20.5, carbs: 62.9, fat: 6 }, reference: { source: "generic dry chickpeas", ediblePortion: true, state: "dry", policy: "representative-not-brand" } },
  ...
  { id: "quinoa-dry", name: { en: "Dry quinoa", he: "קינואה יבשה" }, aliases: ["dry quinoa", "uncooked quinoa", "raw quinoa", "קינואה יבשה", "קינואה לא מבושלת", "קינואה נאה"], baseAmount: 100, baseUnit: "g", specificity: "generic", macros: { calories: 368, protein: 14.1, carbs: 64.2, fat: 6.1 }, reference: { source: "generic dry quinoa", ediblePortion: true, state: "dry", policy: "representative-not-brand" } },
  ...
  { id: "bulgur-dry", name: { en: "Dry bulgur", he: "בורגול יבש" }, aliases: ["dry bulgur", "uncooked bulgur", "raw bulgur", "בורגול יבש", "בורגול לא מבושל"], baseAmount: 100, baseUnit: "g", specificity: "generic", macros: { calories: 342, protein: 12.3, carbs: 75.9, fat: 1.3 }, reference: { source: "generic dry bulgur", ediblePortion: true, state: "dry", policy: "representative-not-brand" } },
  ...
  { id: "couscous-dry", name: { en: "Dry couscous", he: "קוסקוס יבש" }, aliases: ["dry couscous", "uncooked couscous", "raw couscous", "קוסקוס יבש", "קוסקוס לא מבושל"], baseAmount: 100, baseUnit: "g", specificity: "generic", macros: { calories: 376, protein: 12.8, carbs: 77.4, fat: 0.6 }, reference: { source: "generic dry couscous", ediblePortion: true, state: "dry", policy: "representative-not-brand" } },
