...
const FOOD_CATALOG = Object.freeze([
  ...
  { id: "high-protein-yogurt", name: { en: "High-protein yogurt", he: "יוגורט חלבון" }, aliases: ["high protein yogurt", "protein yogurt", "יוגורט חלבון", "יוגורט פרו"], baseAmount: 1, baseUnit: "item", macros: { calories: 150, protein: 20, carbs: 12, fat: 2 } },
