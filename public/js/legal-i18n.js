...
if (page === "terms") {
  ...
  setMeta('עודכן לאחרונה: 19 בספטמבר 2026 · שאלות? <a href="/contact.html">צור קשר</a>');
...
if (page === "privacy") {
  ...
  translateSections([
    ...
    ["2. כיצד אנו משתמשים בנתונים", "<ul><li>להפעלת חשבונות, תוכניות, מעקב, שיתוף חברתי ותמיכה</li><li>להפעלת תכונת AI שביקשת</li><li>לשליחת התראות אופציונליות לפי ההעדפות שלך</li><li>לאבטחה, מניעת שימוש לרעה ואמינות</li></ul><p>איננו מוכרים מידע אישי לצורכי שיווק.</p><h3>אחסון בדפדפן ואנליטיקה</h3><p>אנו משתמשים באחסון דפדפן הכרחי עבור העדפת שפה, מצב תהליך הכניסה וטיוטות אימון זמניות במכשיר שלך. כברירת מחדל איננו משתמשים בפיקסלים פרסומיים או במעקב התנהגותי של צד שלישי. אם בעתיד יתווספו אנליטיקה לא־הכרחית, פרסום או אחסון דומה, נספק את ההסכמה וההודעה הנדרשות לפני ההפעלה.</p>"],
