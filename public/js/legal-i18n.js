...
if (page === "privacy") {
  ...
  translateSections([
    ...
    ["4. שירותי צד שלישי", "<ul><li><strong>Google Firebase</strong> — הזדהות, מסד נתונים ואחסון קבצים.</li><li><strong>ספקי API של AI</strong> — לצורך הפעלת המאמן הדיגיטלי ויצירת תוכניות. רק נתוני פרופיל כושר נשלחים — ללא מידע מזהה מלא.</li><li><strong>PayPlus</strong> — עיבוד תשלומים מאובטח כאשר תשלומים מופעלים. FuelPhysique לעולם לא שומרת פרטי כרטיס אשראי.</li></ul>"],
