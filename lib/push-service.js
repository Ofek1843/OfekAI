...
class PushNotificationService {
  ...
  updatePreferences(uid, input) {
    const allowed = new Set(["notificationsEnabled", "newMessages", "sharedPlans", "workoutReminders", "reminderTime", "showMessagePreviews", "locale", "timezone"]);
    ...
    for (const key of ["notificationsEnabled", "newMessages", "sharedPlans", "workoutReminders", "showMessagePreviews"]) {
