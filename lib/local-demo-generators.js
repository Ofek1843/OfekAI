...
function collectCandidates(equipment, { skillForwardCalisthenics = false, preferFoundations = false, experience = "intermediate" } = {}) {
...
function buildLocalWorkoutProgram({
  ...
  const { candidatesByMuscle } = collectCandidates(equipment, { skillForwardCalisthenics, preferFoundations, experience });
