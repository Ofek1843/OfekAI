...
// Kept in sync with public/js/subscription-plans.js's SUBSCRIPTION_PLANS.pro
// (~$8/month). This billing integration is not wired to the pricing page
// yet (no business/tax registration in place) — see pricing.js, which uses
// a no-payment waitlist instead.
const PRO_PRICE_ILS = 29;
...
module.exports = { PRO_PRICE_ILS, billingConfig, createCheckout, handleCallback, verifyPayPlusHash, serviceAccount, firebaseAccessToken };
