...
const PUBLIC_EXERCISES = {
  ...
  "bulgarian-split-squat": { image: "bulgarian-split-squat.png", setCredits: { quads: 1.0, glutes: 0.75, core: 0.25 }, equipment: "Dumbbell" },
...
const DISABLED_EXERCISES = {
  "assisted-pull-up": { reason: "missing dedicated assisted-pull-up image", replacementIds: ["pull-up", "lat-pulldown", "australian-row"] },
  "assisted-chin-up": { reason: "missing dedicated assisted-chin-up image", replacementIds: ["chin-up", "lat-pulldown"] },
  "bench-dip": { reason: "bench dip is visually distinct from parallel-bar dip", replacementIds: ["tricep-dip", "cable-tricep-pushdown", "diamond-push-up"] },
  "hip-thrust-machine": { reason: "missing dedicated hip-thrust-machine image", replacementIds: ["barbell-hip-thrust", "dumbbell-hip-thrust"] },
  "chest-supported-row": { reason: "missing dedicated chest-supported-row image", replacementIds: ["seated-cable-row", "dumbbell-row", "barbell-row"] },
  "seated-machine-row": { reason: "missing dedicated seated-machine-row image", replacementIds: ["seated-cable-row", "dumbbell-row", "t-bar-row"] },
  "single-arm-cable-row": { reason: "missing dedicated single-arm-cable-row image", replacementIds: ["seated-cable-row", "dumbbell-row"] },
  "reverse-pec-deck": { reason: "missing dedicated reverse-pec-deck image", replacementIds: ["face-pull", "dumbbell-reverse-fly"] },
  "cable-overhead-triceps-extension": { reason: "missing dedicated cable-overhead-triceps-extension image", replacementIds: ["overhead-tricep-extension", "cable-tricep-pushdown"] },
  "hanging-knee-raise": { reason: "missing dedicated hanging-knee-raise image", replacementIds: ["hanging-leg-raise", "plank"] },
  "incline-dumbbell-curl": { reason: "missing dedicated incline-dumbbell-curl image", replacementIds: ["dumbbell-curl", "hammer-curl"] },
  "standing-calf-raise": { reason: "current standing-calf-raise image depicts a seated calf raise", replacementIds: ["seated-calf-raise", "dumbbell-calf-raise"] },
  "standing-calf-raise-machine": { reason: "current standing-calf-raise image depicts a seated calf raise", replacementIds: ["seated-calf-raise", "dumbbell-calf-raise"] },
  "conventional-deadlift": { reason: "missing dedicated conventional-deadlift image", replacementIds: ["romanian-deadlift", "sumo-deadlift"] },
  "wide-grip-pull-up": { reason: "missing dedicated wide-grip-pull-up image", replacementIds: ["pull-up", "lat-pulldown"] },
  "forward-lunge": { reason: "missing dedicated forward-lunge image", replacementIds: ["dumbbell-walking-lunge", "reverse-lunge"] },
  crunch: { reason: "missing dedicated crunch image", replacementIds: ["cable-crunch", "plank"] }
};
...
const WORKOUT_EXERCISE_ALIAS_MAP = { ...SAFE_ALIASES, ...DISABLED_ALIASES };
