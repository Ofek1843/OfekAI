...
// Secondary rear_delts/traps credit on rowing and pulling movements: before
// this, only 3 dedicated isolation exercises (dumbbell-reverse-fly,
// face-pull, reverse-pec-deck for rear_delts; barbell-shrug, dumbbell-shrug,
// barbell-upright-row for traps) carried ANY credit for these two muscles.
// A program that doesn't happen to include one of those specific exercises
// showed a hard 0 for rear delts or traps even after a normal back day with
// several rows and pulldowns -- physiologically wrong, since horizontal
// rowing recruits the rear deltoids as synergists in scapular retraction,
// and both rowing and vertical pulling load the traps for scapular
// stabilization/depression. Credits below are deliberately conservative
// secondary values (0.25-0.5), not primary-equivalent, and were the direct
// fix for muscle groups showing a false "0 weekly sets" despite a
// perfectly normal back-focused session.
const PUBLIC_EXERCISES = {
  "dumbbell-floor-press": {"image":"dumbbell-floor-press.png","setCredits":{"chest":1,"triceps":0.5,"delts":0.25},"equipment":"Dumbbell"},
  "dumbbell-reverse-lunge": {"image":"dumbbell-reverse-lunge.png","setCredits":{"quads":1,"glutes":0.75},"equipment":"Dumbbell"},
  "bodyweight-glute-bridge": {"image":"bodyweight-glute-bridge.png","setCredits":{"glutes":1,"hamstrings":0.25},"equipment":"Bodyweight"},
  "dead-bug": {"image":"dead-bug.png","setCredits":{"core":1},"equipment":"Bodyweight"},
  "standing-bodyweight-calf-raise": {"image":"standing-bodyweight-calf-raise.png","setCredits":{"calves":1},"equipment":"Bodyweight"},
  "ring-row": {"image":"ring-row.png","setCredits":{"back":1,"biceps":0.5,"rear_delts":0.25},"equipment":"Rings"},
  ...
  "australian-row": { image: "australian-row.png", setCredits: { back: 1.0, biceps: 0.5, rear_delts: 0.5, traps: 0.25 }, equipment: "Bodyweight" },
  ...
  "barbell-row": { image: "barbell-row.png", setCredits: { back: 1.0, biceps: 0.5, delts: 0.25, rear_delts: 0.5, traps: 0.25 }, equipment: "Barbell" },
  ...
  "chin-up": { image: "chin-up.png", setCredits: { back: 1.0, biceps: 1.0, traps: 0.25 }, equipment: "Pull-up Bar" },
  "close-grip-bench-press": { image: "close-grip-bench-press.png", setCredits: { triceps: 1.0, chest: 0.5, delts: 0.25 }, equipment: "Barbell" },
  "close-grip-lat-pulldown": { image: "close-grip-lat-pulldown.png", setCredits: { back: 1.0, biceps: 0.5, traps: 0.25 }, equipment: "Cable" },
  ...
  "dumbbell-row": { image: "dumbbell-row.png", setCredits: { back: 1.0, biceps: 0.5, rear_delts: 0.5, traps: 0.25 }, equipment: "Dumbbell" },
  ...
  "lat-pulldown": { image: "lat-pulldown.png", setCredits: { back: 1.0, biceps: 0.5, traps: 0.25 }, equipment: "Cable" },
  ...
  "muscle-up": { image: "muscle-up.png", setCredits: { back: 1.0, chest: 0.5, triceps: 0.5, biceps: 0.5, traps: 0.25 }, equipment: "Pull-up Bar" },
  "neutral-grip-pull-up": { image: "neutral-grip-pull-up.png", setCredits: { back: 1.0, biceps: 0.75, traps: 0.25 }, equipment: "Pull-up Bar" },
  "one-arm-pull-up": { image: "one-arm-pull-up.png", setCredits: { back: 1.0, biceps: 1.0, traps: 0.25 }, equipment: "Pull-up Bar" },
  ...
  "pull-up": { image: "pull-up.png", setCredits: { back: 1.0, biceps: 0.5, traps: 0.25 }, equipment: "Pull-up Bar" },
  ...
  "seated-cable-row": { image: "seated-cable-row.png", setCredits: { back: 1.0, biceps: 0.5, rear_delts: 0.5, traps: 0.25 }, equipment: "Cable" },
  ...
  "t-bar-row": { image: "t-bar-row.png", setCredits: { back: 1.0, biceps: 0.5, rear_delts: 0.5, traps: 0.25 }, equipment: "Machine" },
  "tricep-dip": { image: "tricep-dip.png", setCredits: { triceps: 1.0, chest: 0.5, delts: 0.25 }, equipment: "Parallel Bars" },
  "typewriter-pull-ups": { image: "typewriter-pull-ups.png", setCredits: { back: 1.0, biceps: 0.75, traps: 0.25 }, equipment: "Pull-up Bar" },
  "wide-grip-push-up": { image: "wide-grip-push-up.png", setCredits: { chest: 1.0, triceps: 0.5, delts: 0.5 }, equipment: "Bodyweight" },

  // Advanced calisthenics skills with dedicated local demonstrations.
  planche: { image: "planche.png", setCredits: { chest: 1.0, delts: 0.75, triceps: 0.75, core: 0.5 }, equipment: "Bodyweight" },
  "front-lever": { image: "front-lever.png", setCredits: { back: 1.0, core: 0.75, biceps: 0.5 }, equipment: "Pull-up Bar" },

  // --- Newly imaged (previously in DISABLED_EXERCISES pending dedicated art) ---
  "assisted-pull-up": { image: "assisted-pull-up.png", setCredits: { back: 1.0, biceps: 0.5, traps: 0.25 }, equipment: "Machine" },
  "assisted-chin-up": { image: "assisted-chin-up.png", setCredits: { back: 1.0, biceps: 0.75, traps: 0.25 }, equipment: "Machine" },
  ...
  "chest-supported-row": { image: "chest-supported-row.png", setCredits: { back: 1.0, biceps: 0.5, delts: 0.25, rear_delts: 0.5, traps: 0.25 }, equipment: "Machine" },
  "seated-machine-row": { image: "seated-machine-row.png", setCredits: { back: 1.0, biceps: 0.5, rear_delts: 0.5, traps: 0.25 }, equipment: "Machine" },
  "single-arm-cable-row": { image: "single-arm-cable-row.png", setCredits: { back: 1.0, biceps: 0.5, rear_delts: 0.5, traps: 0.25 }, equipment: "Cable" },
  ...
  "wide-grip-pull-up": { image: "wide-grip-pull-up.png", setCredits: { back: 1.0, biceps: 0.5, traps: 0.25 }, equipment: "Pull-up Bar" },
  "forward-lunge": { image: "forward-lunge.png", setCredits: { quads: 1.0, glutes: 0.75 }, equipment: "Bodyweight" },
  "nordic-hamstring-curl": { image: "nordic-hamstring-curl.png", setCredits: { hamstrings: 1.0, glutes: 0.25 }, equipment: "Bodyweight" },
  "dragon-flag": { image: "dragon-flag.png", setCredits: { core: 1.0 }, equipment: "Bodyweight" },
  "ring-muscle-up": { image: "ring-muscle-up.png", setCredits: { back: 1.0, chest: 0.5, triceps: 0.5, biceps: 0.5 }, equipment: "Rings" },
  "landmine-press": { image: "landmine-press.png", setCredits: { delts: 1.0, triceps: 0.5, chest: 0.25 }, equipment: "Barbell" },
  "sissy-squat": { image: "sissy-squat.png", setCredits: { quads: 1.0, glutes: 0.25 }, equipment: "Bodyweight" },
  "cable-glute-kickback": { image: "cable-glute-kickback.png", setCredits: { glutes: 1.0 }, equipment: "Cable" },
  "bayesian-cable-curl": { image: "bayesian-cable-curl.png", setCredits: { biceps: 1.0 }, equipment: "Cable" },
  "pallof-press": { image: "pallof-press.png", setCredits: { core: 1.0 }, equipment: "Cable" },
  "ring-dip": { image: "ring-dip.png", setCredits: { chest: 1.0, triceps: 1.0, delts: 0.5 }, equipment: "Rings" },
  "pseudo-planche-push-up": { image: "pseudo-planche-push-up.png", setCredits: { chest: 1.0, delts: 0.75, triceps: 0.75, core: 0.25 }, equipment: "Bodyweight" },
  "toes-to-bar": { image: "toes-to-bar.png", setCredits: { core: 1.0 }, equipment: "Pull-up Bar" },
  "tibialis-raise": { image: "tibialis-raise.png", setCredits: { calves: 1.0 }, equipment: "Bodyweight" }
};

// Movements the generator can produce (in any UI language — the prompt
// always asks the AI for an English lowercase-hyphenated exerciseId even
// when name/demoName are Hebrew) that have no accurate dedicated image in
// public/images/exercises. Every current image is a strength or skill
// movement; none is a stretch/mobility/warm-up/cool-down photo, so these
// must not render at all rather than fall back to the generic branded image
// or a misleading strength-exercise surrogate. replacementIds is empty
// because no enabled catalog exercise preserves the same
// bodyweight/mobility/no-load intent.
const DISABLED_EXERCISES = {
  "bodyweight-shoulder-stretch": {
    reason: "no dedicated stretch/mobility image exists for this movement",
    replacementIds: []
  }
};
...
const DISABLED_ALIASES = {
  "bodyweight-shoulder-stretch": "bodyweight-shoulder-stretch",
  "shoulder-stretch": "bodyweight-shoulder-stretch",
  "shoulder-stretch-with-bodyweight": "bodyweight-shoulder-stretch",
  "standing-shoulder-stretch": "bodyweight-shoulder-stretch",
  "cross-body-shoulder-stretch": "bodyweight-shoulder-stretch"
};
