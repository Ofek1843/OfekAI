...
function runProfile(program) {
  ...
  return { repaired, validation, perMuscle, mappingCoveragePercent, unknownExercises, outOfRangeRequired, volumePassed, allowed };
}

function assertFullySuccessful(result, label) {
  const { repaired, validation, mappingCoveragePercent, unknownExercises, outOfRangeRequired, volumePassed, allowed } = result;
