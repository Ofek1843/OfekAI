...
test("the PWA cache is versioned with the Illustrated V4 assets and private voice remains network-only", () => {
  ...
  assert.match(sw, /illustrated-v4\.css\?v=20260815-real-athlete-v43-training-final-8/);
  assert.match(sw, /illustrated-v4\.js\?v=20260815-real-athlete-v43-training-final-2/);
