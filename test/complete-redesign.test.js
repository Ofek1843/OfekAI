...
test("the service worker versions and pre-caches the shared redesign assets", () => {
  assert.match(SW, /fuelphysique-v16-premium-v42/);
  ...
  assert.ok(SW.includes("/css/illustrated-v4.css?v=20260814-premium-v42-final"));
  assert.ok(SW.includes("/js/illustrated-v4.js?v=20260814-premium-v42-final"));
