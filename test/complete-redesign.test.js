...
test("the service worker versions and pre-caches the shared redesign assets", () => {
  assert.match(SW, /fuelphysique-v28-real-athlete-v43-complete-4/);
  ...
  assert.ok(SW.includes("/css/illustrated-v4.css?v=20260815-real-athlete-v43-complete-4"));
  assert.ok(SW.includes("/js/illustrated-v4.js?v=20260815-real-athlete-v43-complete-4"));
