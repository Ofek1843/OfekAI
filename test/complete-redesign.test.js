...
test("the service worker versions and pre-caches the shared redesign assets", () => {
  ...
  assert.ok(SW.includes("/css/illustrated-v4.css?v=20260814-real-athlete-v43-polish-3"));
  assert.ok(SW.includes("/js/illustrated-v4.js?v=20260814-real-athlete-v43-polish-3"));
